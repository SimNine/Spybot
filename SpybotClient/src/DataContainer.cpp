...
void initData()
{
	...
	dataContainer->map_button_joingame = loadTexture("resources/map/joinexisting.png");
    ...
    dataContainer->tile_selected = loadTexture("resources/board/tile_selected_bold.png");
	...
	dataContainer->game_icon_dead = loadTexture("resources/lobby/dead_30px.png");
	dataContainer->game_icon_owner = loadTexture("resources/lobby/crown_35px_30px.png");
	dataContainer->game_icon_human = loadTexture("resources/lobby/person_23px_30px.png");
	dataContainer->game_icon_ai = loadTexture("resources/lobby/cpu_30px.png");
	dataContainer->game_icon_currTurn = loadTexture("resources/lobby/arrow_30px.png");
	...
	dataContainer->main_button_multiplayer = "resources/main/menu_button_multiplayer.png";
	dataContainer->main_button_multiplayer_over = "resources/main/menu_button_multiplayer_over.png";
