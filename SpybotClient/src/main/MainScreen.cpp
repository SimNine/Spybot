...
MainScreen::MainScreen()
	...
	GUIButton* button_nightfall = new GUIButton(ANCHOR_SOUTHWEST, { 20, -(41 + 20)*ln++ - 20 }, { 349, 41 }, mainContainer_,
		[] () {
		_connectionManager->connectToLocalServer();
	...
	loginUsername_ = new GUITextbox(ANCHOR_NORTHWEST, { 20, 80 }, { 760, 40 }, loginEntryContainer_, DEFAULT_MSG_TEXTSIZE / 2 - 5, false);
	...
	loginPassword_ = new GUITextbox(ANCHOR_NORTHWEST, { 20, 200 }, { 760, 40 }, loginEntryContainer_, DEFAULT_MSG_TEXTSIZE / 2 - 5, true);
	loginEntryContainer_->addObject(loginPassword_);
	loginCancelButton_ = new GUIButton(ANCHOR_SOUTHWEST, { 20, -20 }, "Cancel", loginEntryContainer_, [] () {_mainScreen->loginHide(); _connectionManager->disconnect(); });
