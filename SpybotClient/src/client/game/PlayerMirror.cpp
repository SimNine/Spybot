...
PlayerMirror::PlayerMirror(GameMirror* g, int t) {
	game_ = g;
	team_ = t;
	selectedTile_ = { -1, -1 };
...
PlayerMirror::~PlayerMirror() {
	printf("CLIENT: player %i deleted\n", playerID_);
...
void PlayerMirror::setPlayerID(int playerID) {
	playerID_ = playerID;
}
