...
public:
	...
	SDL_Texture* map_button_joingame;
	...
	SDL_Texture* game_icon_dead;
	SDL_Texture* game_icon_owner;
	SDL_Texture* game_icon_ai;
	SDL_Texture* game_icon_human;
	SDL_Texture* game_icon_currTurn;
	...
	std::string main_button_multiplayer;
	std::string main_button_multiplayer_over;
